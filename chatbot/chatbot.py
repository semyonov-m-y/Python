...
# Раскомментировать только при первом запуске
#nltk.download('punkt')
...
#Токенизация
sent_tokens = nltk.sent_tokenize(raw) # конвертируем в список предложений
word_tokens = nltk.word_tokenize(raw) # конвертируем в список слов
